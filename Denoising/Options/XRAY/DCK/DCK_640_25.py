...
SIGMA = 25
Train_Dataroot_GT = r"Z:\14-调试数据\lxm\Dataset\DeNoise_XRAY\电池壳\DCK_train_640"
Train_Dataroot_LQ = "none"
Val_Dataroot_GT = r"Z:\14-调试数据\lxm\Dataset\DeNoise_XRAY\电池壳\DCK_val_640"
Val_Dataroot_LQ = "none"

Pretrain_Network_G = r"./Denoising/pretrained_models/gaussian_gray_denoising_blind.pth"
WARMUP_ITER = 500

GT_SIZE = 640  # 修改这里可以自动更新gt_sizes和mini_batch_sizes
