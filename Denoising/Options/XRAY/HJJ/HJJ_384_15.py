...
SIGMA = 15
Train_Dataroot_GT = r"Z:\14-调试数据\lxm\Dataset\DeNoise_XRAY\HJJ\HJJ_train_384"
Train_Dataroot_LQ = "none"
Val_Dataroot_GT = r"Z:\14-调试数据\lxm\Dataset\DeNoise_XRAY\HJJ\HJJ_val_384"
Val_Dataroot_LQ = "none"

Pretrain_Network_G = r"./Denoising/pretrained_models/gaussian_gray_denoising_blind.pth"
WARMUP_ITER = 500

GT_SIZE = 384  # 修改这里可以自动更新gt_sizes和mini_batch_sizes
